...
async def test_register_success_triggers_and_executes_task(client, setup_uow, create_model_factory):
    async with setup_uow as uow:
        ...
        await create_model_factory(
            uow, "event", id=1, user_id=999, state="approved", title="E", description="D",
        ...
        await create_model_factory(uow, "ticket", id=10, event_id=1, type_id=1, price=100, status="available",
